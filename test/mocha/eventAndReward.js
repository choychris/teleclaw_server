...
function testCases(description, endTime, maxNum, currentNum, users, code){
  console.log(description);
  // |================== Create Event API ==================|
  // describe('create referral event', function(){
  ...
  //|================== Peform Refer API ==================|
  describe('a user refer another user', function(){
    it('refer success - status 200 and token', function(done){
    console.log(global.code);
    var api = supertest.agent(baseUrl);
    var data = {
...
//       "endTime": "2018-01-03T13:06:35.885Z",
//       "code": "S1QNLEcXz",
//       "rewardAmount": 60,
//       "maxNum": 30
//     };
...
let validUser = [];
let inValidUser = [ '5a3b720bbf73350182f3d254' ];

let cases = [
  {description: 'user joined', endTime: validEndTime, maxNum: null, currentNum: 0, users: inValidUser},
  // {description: 'event full', endTime: validEndTime, maxNum: 10, currentNum: 10, users: validUser},
  // {description: 'event ended', endTime: inValidEndTime, maxNum: null, currentNum: 0, users: validUser},
  // {description: 'wrong code', endTime: validEndTime, maxNum: null, currentNum: 0, users: validUser, code: 'abc'},
]
